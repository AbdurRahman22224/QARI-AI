...
import { Mic, Loader2, AlertCircle, Info, BarChart3, Volume2, Headphones, RefreshCw, Target, Clock, AudioLines, X, PlayCircle, Check, Zap, BookOpen, XCircle, ChevronLeft, ChevronRight } from 'lucide-react';
...
const MAKHRAJ_TIPS = {
  'ء': 'ء: From the throat, sharp stop.',
  'ا': 'ا: From empty space, depends on preceding letter.',
  'ب': 'ب: Lips close and release softly.',
  'ت': 'ت: Tip of tongue touches upper front teeth.',
  'ث': 'ث: Tip of tongue slightly between teeth.',
  'ج': 'ج: Middle of tongue touches palate.',
  'ح': 'ح: Middle of throat, dry friction.',
  'خ': 'خ: Upper throat, rough sound.',
  'د': 'د: Tip of tongue touches upper teeth.',
  'ذ': 'ذ: Tongue lightly between teeth.',
  'ر': 'ر: Tip of tongue taps upper palate.',
  'ز': 'ز: Tip of tongue near teeth with buzzing.',
  'س': 'س: Air flows smoothly, light whistle.',
  'ش': 'ش: Spread tongue, soft hissing.',
  'ص': 'ص: Heavy whistling sound.',
  'ض': 'ض: Side of tongue touches molars.',
  'ط': 'ط: Strong tongue contact with palate.',
  'ظ': 'ظ: Tongue touches edge of upper teeth.',
  'ع': 'ع: Middle throat, deep pressed sound.',
  'غ': 'غ: Upper throat, gurgling sound.',
  'ف': 'ف: Lower lip touches upper teeth.',
  'ق': 'ق: Back of tongue hits soft palate.',
  'ك': 'ك: Slightly forward from Qaf position.',
  'ل': 'ل: Tip of tongue touches upper gums.',
  'م': 'م: Lips closed, nasal sound.',
  'ن': 'ن: Tongue touches gums, nasal flow.',
  'ه': 'ه: Soft breath from throat.',
  'و': 'و: Rounded lips, flowing sound.',
  'ي': 'ي: Middle tongue raises to palate.',
};
